  ...
  return (
    ...
    >
      ...
      className={`bg-black/50 p-5 gap-2 rounded-xl shadow-xl w-full transition-all duration-500 
            flex flex-col  `}
      >
        <h1 className='font-bold text-xl' style={{color:'white'}}>{`Question: ${index}/${quiz.questions.length}`}</h1>

        <img src={image} alt={title}/>

        <div className='bg-white/15 p-4 rounded-lg'>
          <p className='text-md mt-4 font-bold ' style={{color:'white'}}> {title}</p>
        ...
        <div>
          ...
          <h1 id='display' className='font-bold' style={{color:'white'}}>00:00</h1>
